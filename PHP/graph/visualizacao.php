...
<html>
  ...
  <head>
    ...
    <script>
      ...
      function iniciar(){
        intervalo = setInterval("getJson()",3000);  
      }
      ...
      function mensagem(){
        console.log("CHAMOU A FUNÇÃO DA MENSAGEM");
      }

      function getJson(){     
        var variavel = document.getElementById('input_variavel').value;          
        
            $.ajax({
              url: 'graph.php',
              method: 'POST', 
              dataType: 'json',
              data: {pesq:variavel},  //probably you have some parameters
              error: function() {
  ...
  <body>
    ...
    <div id="barra_lateral">
      ...
      <h2>Pesquisa:</h2>
        Nó:<br>
        <input type="text" name="variavel" id="input_variavel"><br>
        <br><br>
        <input type="button" value="Enviar" onclick="iniciar()">
